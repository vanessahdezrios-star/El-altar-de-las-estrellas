...
export default function Mich({ x, y , z}){
...
var textureM=new THREE.TextureLoader().load("./assets/mich.jpg");
var materialM= new THREE.MeshLambertMaterial({map:textureM});
var foto = new THREE.Mesh(fotoplane, materialM);
