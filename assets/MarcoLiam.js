...
export default function Liam({ x, y , z}){
...
var textureL=new THREE.TextureLoader().load("./assets/liam.jpg");
var materialL= new THREE.MeshLambertMaterial({map:textureL});
var foto = new THREE.Mesh(fotoplane, materialL);
