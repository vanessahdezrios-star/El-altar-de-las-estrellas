...
export default function Santana({ x, y , z}){

//----MARCO DE FOTOS SANTANA----
...
var textureS=new THREE.TextureLoader().load("./assets/santana.png");
var materialS= new THREE.MeshLambertMaterial({map:textureS});
var foto = new THREE.Mesh(fotoplane, materialS);
