...
export default function Olivia({ x, y , z}){

//----MARCO DE FOTOS OLIVIA----
...
var textureO=new THREE.TextureLoader().load("./assets/olivia.jpg");
var materialO= new THREE.MeshLambertMaterial({map:textureO});
var foto = new THREE.Mesh(fotoplane, materialO);
