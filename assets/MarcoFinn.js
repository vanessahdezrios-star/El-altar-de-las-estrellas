...
export default function Finn({ x, y , z}){
...
var textureF=new THREE.TextureLoader().load("./assets/finn.jpg");
var materialF= new THREE.MeshLambertMaterial({map:textureF});
var foto = new THREE.Mesh(fotoplane, materialF);
